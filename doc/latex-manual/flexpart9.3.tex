...
%This document provides basic information on FLEXPART version9.3
%developed within the CTBTO project:
% ``Enhancements to FLEXPART Software on a Call-Off Basis''
%
%The modifications have been done by:
%- Don Morton, Boreal Scientific Consulting and University of Alaska Fairbanks
%- Delia Arnold, Zentralanstalt fuer Meteorologie und Geodynamik Austria
%- Marian Harustak, AWST
%
%UPDATE : 2016 May
...
\title{The Lagrangian particle dispersion model FLEXPART version 9.3}
...
\affil[3]{Central Institute for Meteorology and Geodynamics, Vienna, Austria}
\affil[4]{Boreal Scientific Computing, Fairbanks, Alaska}
\affil[5]{Angewandte Wissenschaft Software und Technologie GmbH, Vienna, Austria}

\runningtitle{FLEXPART v9.3 description}
...
\date{Manuscript version from 23 May 2016}
...
\noindent {\bf Summary of the technical changes:}
...
\noindent {\bf Summary of the add-ons:}
...
\hline
makefile.gfortran & with Vtables, GFORTRAN compiler, GRIB1/2 data \\
makefile.ifort & with Vtables, Intel FORTRAN compiler, GRIB1/2 data\\
\hline
\end{tabular}}}
\end{table*}
...
% ----- D Arnold - we have no modifications of physical aspects with respect to version 9
