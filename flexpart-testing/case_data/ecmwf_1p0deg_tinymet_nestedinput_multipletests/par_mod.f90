...
module par_mod
  ...
  !****************************************************************
  ! Parameter defining ECMWF vs GFS mode
  !****************************************************************
  integer,parameter :: unknown_metdata=0
  integer,parameter :: ecmwf_metdata=1
  integer,parameter :: gfs_metdata=2
  ...
  integer,parameter :: maxnests=1, nxmaxn=15, nymaxn=15
