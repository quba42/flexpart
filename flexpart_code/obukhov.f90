...
real function obukhov_ecmwf(ps,tsurf,tdsurf,tlev,ustar,hf,akm,bkm)
  ...
  if(abs(thetastar).gt.1.e-10) then
     obukhov_ecmwf=theta*ustar**2/(karman*ga*thetastar)
  else
     obukhov_ecmwf=9999                        ! zero heat flux
  endif
  if (obukhov_ecmwf.gt. 9999.) obukhov_ecmwf= 9999.
  if (obukhov_ecmwf.lt.-9999.) obukhov_ecmwf=-9999.

end function obukhov_ecmwf
