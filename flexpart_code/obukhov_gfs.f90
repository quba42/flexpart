...
real function obukhov_gfs(ps,tsurf,tdsurf,tlev,ustar,hf,plev)
  ...
  if(abs(thetastar).gt.1.e-10) then
     obukhov_gfs=theta*ustar**2/(karman*ga*thetastar)
  else
     obukhov_gfs=9999                        ! zero heat flux
  endif
  if (obukhov_gfs.gt. 9999.) obukhov_gfs= 9999.
  if (obukhov_gfs.lt.-9999.) obukhov_gfs=-9999.

end function obukhov_gfs
